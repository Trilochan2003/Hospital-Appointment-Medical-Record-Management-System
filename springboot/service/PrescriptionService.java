...
public class PrescriptionService {
	...
	public ResponseEntity<ResponseStructure<Prescription>> createPrescription(Integer id,Prescription prescription){
		...
		response.setData(prescriptionDao.create(id,prescription));

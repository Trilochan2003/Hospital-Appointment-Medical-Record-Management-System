...
public class PrescriptionController {
	...
	@PostMapping("/generate/id/{id}")
	public ResponseEntity<ResponseStructure<Prescription>> createAppointment(@PathVariable Integer id ,@RequestBody Prescription prescription){
		return prescriptionService.createPrescription(id,prescription);
	}
	@GetMapping("/all")
